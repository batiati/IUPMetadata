...
namespace IupMetadata
{
	public class KnownAttributes
	{
		...
		private static readonly AttributeType[] Values = new[]
		{
			...
			new AttributeType { AttributeName = "HOTSPOT", DataType=DataType.String, DataFormat=DataFormat.XYPosColonSeparated }, // Used by 3 controls: Image, ImageRgb, ImageRgba
			...
			new AttributeType { AttributeName = "CARET", DataType=DataType.String, DataFormat=DataFormat.LinColPosCommaSeparated,}, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "SELECTIONPOS", DataType=DataType.String, DataFormat=DataFormat.RangeCommaSeparated,}, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "MASKFLOAT", DataType=DataType.String, DataFormat=DataFormat.FloatRangeCommaSeparated, IsNullable=true}, // Used by 3 controls: List, Multiline, Text
			new AttributeType { AttributeName = "MASKINT", DataType=DataType.String, DataFormat=DataFormat.RangeCommaSeparated, IsNullable=true}, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "DRAGSTART", DataType=DataType.String, DataFormat=DataFormat.XYPosCommaSeparated}, // Used by 31 controls: AnimatedLabel, BackgroundBox, Canvas, ColorBar, ColorBrowser, ColorDlg, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressDlg, ScrollBox, Text, Tree
			...
			new AttributeType { AttributeName = "POSITION", Group = AttributeGroup.Common, DataType=DataType.String, DataFormat=DataFormat.XYPosCommaSeparated, }, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			...
			new AttributeType { AttributeName = "SCREENPOSITION", Group = AttributeGroup.Visual, DataType=DataType.String, DataFormat=DataFormat.XYPosCommaSeparated}, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val
