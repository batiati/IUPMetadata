...
namespace IupMetadata
{
	public class KnownAttributes
	{
		...
		private static readonly AttributeType[] Values = new[]
		{
			...
			new AttributeType { AttributeName = "ANIMATION", ClassName="expander", DataType=DataType.Enum, EnumValues = new EnumValue[] { "SLIDE", "CURTAIN", "NO" }, }, // Used by 2 controls: AnimatedLabel, Expander
			new AttributeType { AttributeName = "FRAME", ClassName="expander", DataType = DataType.Boolean }, // Used by 2 controls: Expander, FlatFrame

			new AttributeType { AttributeName = "FRAME", ClassName="flatframe", DataType=DataType.Enum, EnumValues=new EnumValue[] { "YES", "NO", "CROSSTITLE" }, }, // Used by 2 controls: Expander, FlatFrame
			...
			new AttributeType { AttributeName = "TYPE", ClassName="val", DataType=DataType.Enum, EnumValues = new EnumValue[] { "HORIZONTAL", "VERTICAL" } }, // Used by 3 controls: Dial, Param, Val
			new AttributeType { AttributeName = "TYPE", ClassName="dial", DataType= DataType.Double}, // Used by 3 controls: Dial, Param, Val

			new AttributeType { AttributeName = "DIALOGTYPE", ClassName="messagedlg", DataType=DataType.Enum, EnumValues= new EnumValue[] { "ERROR", "WARNING", "INFORMATION", "QUESTION" } },
			...
			new AttributeType { AttributeName = "STATE", ClassName="expander", DataType=DataType.Enum, EnumValues = new EnumValue[] { "OPEN", "CLOSED" }, },
			new AttributeType { AttributeName = "STATE", ClassName="tree", DataType=DataType.Enum, EnumValues = new EnumValue[] { "EXPANDED", "COLLAPSED" }, },
			new AttributeType { AttributeName = "STATE", ClassName="flattree", DataType=DataType.Enum, EnumValues = new EnumValue[] { "EXPANDED", "COLLAPSED" }, },
			new AttributeType { AttributeName = "STATE", ClassName="progressdlg", DataType=DataType.Enum, EnumValues = new EnumValue[] { "ABORTED", "PROCESSING", "UNDEFINED", "IDLE" }, },

			new AttributeType { ClassName="gridbox", AttributeName = "EXPANDCHILDREN", DataType = DataType.Enum, EnumValues = new EnumValue[] { "YES", "HORIZONTAL", "VERTICAL" , "NONE" } },
			...
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "ColorDlg", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "Dialog", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "FileDlg", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "FontDlg", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "MessageDlg", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			new AttributeType { AttributeName = "SIZE", IsNullable = true, ClassName = "ProgressDlg", Group = AttributeGroup.Common, DataType = DataType.DialogSize, },
			...
			new AttributeType { AttributeName = "DECOROFFSET", DataType=DataType.Size}, // Used by 2 controls: BackgroundBox, FlatFrame
			new AttributeType { AttributeName = "DECORSIZE", DataType=DataType.Size}, // Used by 2 controls: BackgroundBox, FlatFrame
			new AttributeType { AttributeName = "IMINACTIVE", DataType=DataType.String}, // Used by 2 controls: Button, Toggle
			new AttributeType { AttributeName = "TODAY", DataType=DataType.Date}, // Used by 2 controls: Calendar, DatePick
			...
			new AttributeType { AttributeName = "FRAMECOLOR", DataType=DataType.Rgb}, // Used by 2 controls: Expander, FlatFrame
			new AttributeType { AttributeName = "FRAMEWIDTH", DataType=DataType.Int}, // Used by 2 controls: Expander, FlatFrame
			new AttributeType { AttributeName = "FORECOLOR", DataType=DataType.Rgb}, // Used by 2 controls: Expander, FlatTabs
			new AttributeType { AttributeName = "HIGHCOLOR", DataType=DataType.Rgb}, // Used by 2 controls: Expander, FlatTabs
			...
			new AttributeType { AttributeName = "LOADRTFSTATUS", DataType = DataType.Enum, EnumValues = new EnumValue[] {"OK", "FAILED" },  }, // Used by 2 controls: Multiline, Text
			...
			new AttributeType { AttributeName = "SAVERTFSTATUS", DataType = DataType.Enum, EnumValues = new EnumValue[] {"OK", "FAILED" },}, // Used by 2 controls: Multiline, Text
			new AttributeType { AttributeName = "REMOVEFORMATTING", DataType = DataType.Enum, EnumValues = new EnumValue[] {"ALL", "SELECTION" },}, // Used by 2 controls: Multiline, Text
			new AttributeType { AttributeName = "SPIN", DataType = DataType.Boolean}, // Used by 2 controls: Multiline, Text
			new AttributeType { AttributeName = "SPINALIGN", DataType = DataType.Enum, EnumValues = new EnumValue[] { "LEFT", "RIGHT" }, }, // Used by 2 controls: Multiline, Text
			...
			new AttributeType { AttributeName = "CHANGECASE",DataType = DataType.Enum, EnumValues=new EnumValue[] { "UPPER" , "LOWER" , "TOGGLE", "TITLE" } }, // Used by 2 controls: Multiline, Text
			new AttributeType { AttributeName = "ADDFORMATTAG", DataType = DataType.String}, // Used by 2 controls: Multiline, Text
			new AttributeType { AttributeName = "ADDFORMATTAG_HANDLE", DataType = DataType.Handle}, // Used by 2 controls: Multiline, Text
			...
			new AttributeType { AttributeName = "DIRECTION", DataType= DataType.Enum, EnumValues = new EnumValue[] {"NORTH", "SOUTH", "WEST", "EAST" }, }, // Used by 2 controls: SBox, Split
			...
			new AttributeType { AttributeName = "FLATCOLOR", DataType = DataType.Rgb}, // Used by 3 controls: ColorBar, Dial, Gauge
			...
			new AttributeType { AttributeName = "TEXTHLCOLOR", DataType = DataType.Rgb}, // Used by 3 controls: DropButton, FlatButton, FlatToggle
			...
			new AttributeType { AttributeName = "DIALOGTYPE", DataType=DataType.Enum, EnumValues = new EnumValue[] { "SAVE", "DIR", "OPEN" }, },
			...
			new AttributeType { AttributeName = "ORIGINALSCALE", DataType=DataType.Size}, // Used by 3 controls: Image, ImageRgb, ImageRgba
			new AttributeType { AttributeName = "RESHAPE", DataType=DataType.Size}, // Used by 3 controls: Image, ImageRgb, ImageRgba
			new AttributeType { AttributeName = "SCALED", DataType=DataType.Boolean}, // Used by 3 controls: Image, ImageRgb, ImageRgba
			new AttributeType { AttributeName = "HOTSPOT", DataType=DataType.Range}, // Used by 3 controls: Image, ImageRgb, ImageRgba
			...
			new AttributeType { AttributeName = "CARET", DataType=DataType.LinColPos}, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "CLIPBOARD", DataType=DataType.Enum, EnumValues = new EnumValue[] { "COPY", "CUT", "PASTE", "CLEAR", "UNDO", "REDO" } }, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "SELECTION", DataType=DataType.Selection}, // Used by 3 controls: List, Multiline, Text
			new AttributeType { AttributeName = "SELECTIONPOS", DataType=DataType.Range}, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "MASKFLOAT", DataType=DataType.FloatRange, IsNullable=true}, // Used by 3 controls: List, Multiline, Text
			new AttributeType { AttributeName = "MASKINT", DataType=DataType.Range, IsNullable=true}, // Used by 3 controls: List, Multiline, Text
			new AttributeType { AttributeName = "MASKNOEMPTY", DataType=DataType.Boolean}, // Used by 3 controls: List, Multiline, Text
			new AttributeType { AttributeName = "MASKREAL", DataType=DataType.Enum, EnumValues = new EnumValue[] {"SIGNED", "UNSIGNED", }, IsNullable = true }, // Used by 3 controls: List, Multiline, Text
			...
			new AttributeType { AttributeName = "STATUS", ClassName="filedlg", DataType=DataType.Enum, EnumValues = new EnumValue[] { new EnumValue("Normal", 0), new EnumValue("NewFile", 1), new EnumValue("Cancelled", -1) } }, // Used by 4 controls: ColorDlg, FileDlg, FontDlg, ParamBox
			...
			new AttributeType { AttributeName = "BORDERHLCOLOR", DataType = DataType.Rgb}, // Used by 4 controls: DropButton, FlatButton, FlatToggle, FlatVal
			new AttributeType { AttributeName = "BORDERPSCOLOR", DataType = DataType.Rgb}, // Used by 4 controls: DropButton, FlatButton, FlatToggle, FlatVal
			...
			new AttributeType { AttributeName = "BACKCOLOR", DataType=DataType.Rgb}, // Used by 5 controls: BackgroundBox, Expander, FlatFrame, FlatTree, Gauge
			...
			new AttributeType { AttributeName = "TEXTALIGNMENT", DataType=DataType.Enum, EnumValues = new EnumValue[] { "ARIGHT", "ALEFT", "ACENTER" } }, // Used by 5 controls: DropButton, FlatButton, FlatLabel, FlatList, FlatToggle
			...
			new AttributeType { AttributeName = "TEXTPSCOLOR", DataType=DataType.Rgb}, // Used by 5 controls: DropButton, FlatButton, FlatList, FlatToggle, FlatTree
			...
			new AttributeType { AttributeName = "FILTER", ClassName = "text", DataType = DataType.Enum, EnumValues = new EnumValue[] { "LOWERCASE", "NUMBER", "UPPERCASE" }, IsNullable = true },
			new AttributeType { AttributeName = "FILTER", ClassName = "multiline", DataType = DataType.Enum, EnumValues = new EnumValue[] { "LOWERCASE", "NUMBER", "UPPERCASE" }, IsNullable = true },
			...
			new AttributeType { AttributeName = "MARGIN", DataType=DataType.Margin }, // Used by 5 controls: GridBox, HBox, MultiBox, Spin, VBox
			new AttributeType { AttributeName = "NCMARGIN", DataType=DataType.Margin}, // Used by 5 controls: GridBox, HBox, MultiBox, Spin, VBox
			new AttributeType { AttributeName = "NMARGIN", DataType=DataType.Margin}, // Used by 5 controls: GridBox, HBox, MultiBox, Spin, VBox
			new AttributeType { AttributeName = "CMARGIN", DataType=DataType.Margin}, // Used by 5 controls: GridBox, HBox, MultiBox, Spin, VBox
			new AttributeType { AttributeName = "FLAT_ALPHA"}, // Used by 5 controls: Item, SubMenu, Tabs, Toggle, Tree
			new AttributeType { AttributeName = "IMAGEPOSITION", DataType = DataType.Enum, EnumValues = new EnumValue[] { "LEFT", "RIGHT", "BOTTOM", "TOP" } }, // Used by 6 controls: Button, DropButton, FlatButton, FlatLabel, FlatList, FlatToggle
			...
			new AttributeType { AttributeName = "MDIACTIVATE",  DataType=DataType.MdiActivate}, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "MDIARRANGE", DataType = DataType.Enum, EnumValues = new EnumValue[] { "TILEHORIZONTAL", "TILEVERTICAL", "CASCADE", "ICON" } }, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "PLACEMENT", DataType=DataType.Enum, EnumValues = new EnumValue[] { "MAXIMIZED", "MINIMIZED", "FULL", }, IsNullable = true }, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "CUSTOMFRAMECAPTIONLIMITS", DataType=DataType.Range, IsNullable = true}, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "BACKGROUND", DataType=DataType.Rgb }, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "TASKBARBUTTON", DataType=DataType.Enum, EnumValues = new EnumValue[] { "SHOW", "HIDE" }, IsNullable = true }, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "TASKBARPROGRESSSTATE", DataType = DataType.Enum, EnumValues = new EnumValue[] { "NOPROGRESS", "INDETERMINATE", "ERROR", "PAUSED", "NORMAL" }  }, // Used by 6 controls: ColorDlg, Dialog, FileDlg, FontDlg, MessageDlg, ProgressDlg
			...
			new AttributeType { AttributeName = "BORDERCOLOR", DataType=DataType.Rgb}, // Used by 6 controls: DropButton, FlatButton, FlatList, FlatToggle, FlatTree, FlatVal
			...
			new AttributeType { AttributeName = "PSCOLOR", DataType=DataType.Rgb}, // Used by 6 controls: DropButton, FlatButton, FlatList, FlatToggle, FlatTree, FlatVal
			...
			new AttributeType { AttributeName = "COLOR", DataType=DataType.Rgb}, // Used by 7 controls: DetachBox, FlatSeparator, FlatTree, FontDlg, SBox, Split, Tree
			...
			new AttributeType { AttributeName = "HLCOLOR", DataType=DataType.Rgb}, // Used by 7 controls: DropButton, FlatButton, FlatList, FlatToggle, FlatTree, FlatVal, Tree
			...
			new AttributeType { AttributeName = "RESIZE", ClassName = "imagergb", DataType = DataType.Size},
			new AttributeType { AttributeName = "RESIZE", ClassName = "imagergba", DataType = DataType.Size},
			new AttributeType { AttributeName = "RESIZE", ClassName = "image", DataType = DataType.Size},
			...
			new AttributeType { AttributeName = "ALIGNMENT", DataType = DataType.Alignment}, // Used by 16 controls: AnimatedLabel, Button, DropButton, FlatButton, FlatLabel, FlatList, FlatToggle, HBox, Label, Link, Multiline, Spin, Text, Toggle, VBox, ZBox
			new AttributeType { ClassName = "Param", AttributeName = "CONTROL"},
			new AttributeType { AttributeName = "CHILDOFFSET", DataType=DataType.Size}, // Used by 13 controls: BackgroundBox, ColorDlg, Dialog, FileDlg, FlatFrame, FlatScrollBox, FlatTabs, FontDlg, Frame, MessageDlg, ProgressDlg, ScrollBox, Tabs
			new AttributeType { AttributeName = "PADDING", DataType=DataType.Size}, // Used by 14 controls: AnimatedLabel, Button, DropButton, FlatButton, FlatLabel, FlatList, FlatToggle, Gauge, Label, Link, List, Multiline, Text, Toggle
			new AttributeType { AttributeName = "CPADDING", DataType=DataType.Size}, // Used by 14 controls: AnimatedLabel, Button, DropButton, FlatButton, FlatLabel, FlatList, FlatToggle, Gauge, Label, Link, List, Multiline, Text, Tree
			new AttributeType { AttributeName = "ORIENTATION",DataType = DataType.Enum, EnumValues = new EnumValue[] { "HORIZONTAL", "VERTICAL" }, }, // Used by 14 controls: ColorBar, DetachBox, Dial, FlatSeparator, FlatVal, Gauge, GridBox, HBox, MultiBox, ProgressBar, Spin, Split, Val, VBox
			...
			new AttributeType { AttributeName = "DRAWBGCOLOR", DataType=DataType.Rgb}, // Used by 18 controls: BackgroundBox, Canvas, ColorBar, ColorBrowser, Dial, DropButton, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, Gauge, ScrollBox
			new AttributeType { AttributeName = "DRAWCOLOR", DataType=DataType.Rgb}, // Used by 18 controls: BackgroundBox, Canvas, ColorBar, ColorBrowser, Dial, DropButton, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, Gauge, ScrollBox
			...
			new AttributeType { AttributeName = "DRAWSIZE", DataType = DataType.Size}, // Used by 18 controls: BackgroundBox, Canvas, ColorBar, ColorBrowser, Dial, DropButton, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, Gauge, ScrollBox
			new AttributeType { AttributeName = "DRAWSTYLE", DataType=DataType.Enum, EnumValues = new EnumValue[] { "FILL", "STROKE_DASH", "STROKE_DOT", "STROKE_DASH_DOT", "STROKE_DASH_DOT_DOT", "DRAW_STROKE" } }, // Used by 18 controls: BackgroundBox, Canvas, ColorBar, ColorBrowser, Dial, DropButton, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, Gauge, ScrollBox
			new AttributeType { AttributeName = "DRAWTEXTALIGNMENT", DataType=DataType.Enum, EnumValues = new EnumValue[] { "ACENTER", "ARIGHT", "ALEFT" } }, // Used by 18 controls: BackgroundBox, Canvas, ColorBar, ColorBrowser, Dial, DropButton, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, Gauge, ScrollBox
			...
			new AttributeType { AttributeName = "FGCOLOR", DataType = DataType.Rgb}, // Used by 21 controls: AnimatedLabel, Button, Dial, DropButton, FlatButton, FlatLabel, FlatList, FlatToggle, FlatTree, FlatVal, Frame, Gauge, Label, Link, List, Multiline, ProgressBar, Tabs, Text, Toggle, Tree
			...
			new AttributeType { AttributeName = "CLIENTOFFSET", DataType = DataType.Size}, // Used by 27 controls: BackgroundBox, CBox, ColorDlg, DetachBox, Dialog, Expander, FileDlg, FlatFrame, FlatScrollBox, FlatTabs, FontDlg, Frame, GridBox, HBox, MessageDlg, MultiBox, ParamBox, ProgressDlg, Radio, SBox, ScrollBox, Spin, SpinBox, Split, Tabs, VBox, ZBox
			new AttributeType { AttributeName = "CLIENTSIZE", DataType = DataType.Size}, // Used by 27 controls: BackgroundBox, CBox, ColorDlg, DetachBox, Dialog, Expander, FileDlg, FlatFrame, FlatScrollBox, FlatTabs, FontDlg, Frame, GridBox, HBox, MessageDlg, MultiBox, ParamBox, ProgressDlg, Radio, SBox, ScrollBox, Spin, SpinBox, Split, Tabs, VBox, ZBox
			...
			new AttributeType { AttributeName = "DRAGSTART", DataType = DataType.XYPos}, // Used by 31 controls: AnimatedLabel, BackgroundBox, Canvas, ColorBar, ColorBrowser, ColorDlg, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressDlg, ScrollBox, Text, Tree
			...
			new AttributeType { AttributeName = "TABORIENTATION", DataType = DataType.Enum, EnumValues = new EnumValue[] { "HORIZONTAL", "VERTICAL" } }, // Used by 2 controls: FlatTabs, Tabs
			new AttributeType { AttributeName = "TABTITLE", DataType = DataType.String}, // Used by 2 controls: FlatTabs, Tabs
			new AttributeType { AttributeName = "TABTYPE", DataType = DataType.Enum, EnumValues = new EnumValue[] { "BOTTOM", "LEFT" , "RIGHT" , "TOP" } }, // Used by 2 controls: FlatTabs, Tabs
			new AttributeType { AttributeName = "TABVISIBLE", DataType = DataType.Boolean}, // Used by 2 controls: FlatTabs, Tabs
			new AttributeType { AttributeName = "TOGGLEVALUE", DataType = DataType.Enum, EnumValues = new EnumValue[] { "ON", "OFF", "NOTDEF" } }, // Used by 2 controls: FlatTree, Tree
			...
			new AttributeType { AttributeName = "NORMALIZESIZE", DataType = DataType.Enum, EnumValues = new EnumValue[] { "HORIZONTAL", "VERTICAL", "BOTH", "NONE" } }, // Used by 4 controls: GridBox, HBox, Spin, VBox
			...
			new AttributeType { AttributeName = "FLOATING", Group = AttributeGroup.Common, DataType = DataType.Enum, EnumValues = new EnumValue[] { "YES", "IGNORE", "NO" }}, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "EXPAND", Group = AttributeGroup.Common, DataType = DataType.Enum, EnumValues = new EnumValue[] { "YES", "HORIZONTAL", "VERTICAL", "HORIZONTALFREE", "VERTICALFREE", "NO" }}, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			...
			new AttributeType { AttributeName = "SIZE", Group = AttributeGroup.Common, DataType = DataType.Size, IsNullable = true }, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "RASTERSIZE", Group = AttributeGroup.Common, DataType = DataType.Size, IsNullable = true }, // Used by 58 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Image, ImageRgb, ImageRgba, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "CHARSIZE", Group = AttributeGroup.Common, DataType = DataType.Size, IsNullable = true}, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "NATURALSIZE", Group = AttributeGroup.Common, DataType = DataType.Size, IsNullable = true }, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "USERSIZE", Group = AttributeGroup.Common, DataType = DataType.Size, IsNullable = true }, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "POSITION", Group = AttributeGroup.Common, DataType = DataType.XYPos, }, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "MAXSIZE", Group = AttributeGroup.Common, DataType = DataType.Size,}, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			new AttributeType { AttributeName = "MINSIZE", Group = AttributeGroup.Common, DataType = DataType.Size,}, // Used by 55 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, CBox, ColorBar, ColorBrowser, ColorDlg, DatePick, DetachBox, Dial, Dialog, DropButton, Expander, FileDlg, Fill, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, GridBox, HBox, Label, Link, List, MessageDlg, MultiBox, Multiline, ParamBox, ProgressBar, ProgressDlg, Radio, SBox, ScrollBox, Space, Spin, SpinBox, Split, Tabs, Text, Toggle, Tree, Val, VBox, ZBox
			...
			new AttributeType { AttributeName = "ZORDER", Group = AttributeGroup.Visual, DataType = DataType.Enum, EnumValues = new EnumValue[] { "TOP", "BOTTOM" } }, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val
			...
			new AttributeType { AttributeName = "SCREENPOSITION", Group = AttributeGroup.Visual, DataType = DataType.XYPos}, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val
			...
			new AttributeType { AttributeName = "TIPBGCOLOR", Group = AttributeGroup.Visual, DataType = DataType.Rgb}, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val
			new AttributeType { AttributeName = "TIPFGCOLOR", Group = AttributeGroup.Visual, DataType = DataType.Rgb}, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val
			new AttributeType { AttributeName = "TIPRECT", Group = AttributeGroup.Visual, DataType = DataType.Rect}, // Used by 39 controls: AnimatedLabel, BackgroundBox, Button, Calendar, Canvas, ColorBar, ColorBrowser, ColorDlg, DatePick, Dial, Dialog, DropButton, FileDlg, FlatButton, FlatFrame, FlatLabel, FlatList, FlatScrollBox, FlatSeparator, FlatTabs, FlatToggle, FlatTree, FlatVal, FontDlg, Frame, Gauge, Label, Link, List, MessageDlg, Multiline, ProgressBar, ProgressDlg, ScrollBox, Tabs, Text, Toggle, Tree, Val

			new AttributeType { AttributeName = "SEPARATOR", ClassName = "label", DataType = DataType.Enum, EnumValues = new EnumValue[] { "HORIZONTAL", "VERTICAL" } },
			...
			new AttributeType { AttributeName = "BUTTONS", ClassName = "messagedlg", DataType = DataType.Enum, EnumValues = new EnumValue[] { "OKCANCEL", "RETRYCANCEL", "YESNO", "YESNOCANCEL", "OK" } },
			...
			new AttributeType { AttributeName = "VALUE", ClassName = "toggle", DataType = DataType.Enum, EnumValues = new EnumValue[] { "ON", "OFF", "NOTDEF" } },
